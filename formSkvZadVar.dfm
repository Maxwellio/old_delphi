object frmSkvZadVar: TfrmSkvZadVar
  Left = 619
  Top = 299
  Width = 594
  Height = 751
  ...
  object Panel2: TPanel
    ...
    object Label3: TLabel
      ...
      FocusControl = DBEdPLANCLOSEDDATE
      ParentShowHint = False
      ShowHint = True
    end
    ...
    object DBChBPLANCLOSED: TDBCheckBox
      Left = 330
      Top = 44
      Width = 136
      Height = 13
    ...
    object DBEdPLANCLOSEDDATE: TDBEdit
      Left = 165
      Top = 37
      Width = 152
      Height = 21
    ...
    object DBEdPLANBEGDATE: TDBEdit
      Left = 6
      Top = 39
      Width = 152
      Height = 21
  ...
  object qrParAndZnPlan: TPgQuery
    ...
    object qrParAndZnPlandefnar: TIntegerField
      FieldName = 'defnar'
      Required = True
    end
    object qrParAndZnPlanprnum: TFloatField
      FieldName = 'prnum'
      Required = True
    end
    object qrParAndZnPlanparcode: TFloatField
      FieldName = 'parcode'
      Required = True
    end
    object qrParAndZnPlannm: TStringField
      FieldName = 'nm'
      Size = 200
    end
    object qrParAndZnPlanznval: TFloatField
      FieldName = 'znval'
    end
    object qrParAndZnPlanznnm: TStringField
      FieldName = 'znnm'
      Size = 200
    end
    object qrParAndZnPlanval: TFloatField
      FieldName = 'val'
    end
    object qrParAndZnPlanvalstr: TStringField
      FieldName = 'valstr'
      Size = 150
    end
  end
  ...
  object SZADANIE_SET_DATE: TPgStoredProc
    StoredProcName = 'BURNAR.ZADANIE_SET_DATE'
    Connection = frmMain.MConnection
    SQL.Strings = (
      'CALL BURNAR.ZADANIE_SET_DATE(:nkey)')
    Left = 248
    Top = 336
    ParamData = <
      item
    ...
    CommandStoredProcName = 'BURNAR.ZADANIE_SET_DATE:0'
  end
end
